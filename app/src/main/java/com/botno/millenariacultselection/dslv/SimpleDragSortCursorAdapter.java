...
package com.botno.millenariacultselection.dslv;
...
public class SimpleDragSortCursorAdapter extends ResourceDragSortCursorAdapter {
     ...
     * @see #getViewBinder()
     * @see #setViewBinder(ViewBinder) (android.widget.SimpleCursorAdapter.ViewBinder)
     ...
     * @see #setCursorToStringConverter(CursorToStringConverter) (android.widget.SimpleCursorAdapter.CursorToStringConverter)
